        ...
        <Card bordered={false}>
          <Form onSubmit={this.handleSubmit} hideRequiredMark style={{ marginTop: 8 }}>
            ...
            <FormItem {...formItemLayout} label='目标描述'>
              ...
              })(<TextArea style={{ minHeight: 32 }} placeholder='请输入你的阶段性工资目标' rows={4} />)}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label={
              <span>客户<em className={styles.optional}>（选填）<Tooltip title='目标的服务对象'><Icon type='info-circle-o' style={{ marginRight: 4 }} /></Tooltip></em></span>
            }>
              {getFieldDecorator('client')(<Input placeholder='请描述你服务的客户，内部客户直接@姓名/工号' />)}
            </FormItem>
            <FormItem {...formItemLayout} label={<span>邀评人<em className={styles.optional}>（选填）</em></span>}>
              {getFieldDecorator('invites')(
                <Input placeholder="请直接 @姓名／工号，最多可邀请 5 人" />
              )}
            </FormItem>
            <FormItem {...formItemLayout} label={<span>权重<em className={styles.optional}>（选填）</em></span>}>
