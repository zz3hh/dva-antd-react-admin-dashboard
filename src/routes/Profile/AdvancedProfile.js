...
const getWindowWidth = () => (window.innerWidth || window.documentElement.clientWidth);
...
const description = (
  <DescriptionList className={styles.headerList} size="small" col="2">
    ...
    <Description term="关联订单"><a href="">12421</a></Description>
      ...
      >
        ...
        <Card title="用户信息" style={{ marginBottom: 24 }} bordered={false}>
          <DescriptionList style={{ marginBottom: 24 }}>
            <Description term="用户信息">付晓晓</Description>
