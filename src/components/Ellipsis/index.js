...
export default class Ellipsis extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (this.componentWillReceiveProps.lines !== nextProps.lines) {
      this.computeLine();
    }
  }
  ...
  computeLine = () => {
    ...
    if (lines && !isSupportLineClamp) {
      ...
      const lineHegiht = parseInt(getComputedStyle(this.root).lineHeight, 10);
      const targetHeight = lines * lineHegiht;
